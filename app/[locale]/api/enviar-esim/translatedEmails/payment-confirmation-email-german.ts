...
export function paymentConfirmationEmailGerman(paymentEmailInformation: PaymentEmailInformation) {
    return `<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="left" style="font-family: Arial, sans-serif; padding: 20px; border: 2px solid #C7C7C7; border-radius: 8px;">
                                        ...
                                        <span style="float: right; font-size: 14px;">Bestellung ${paymentEmailInformation.orderNumber}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #E4E4E4; border-radius: 8px;">
                                <tr>
                                    <td style="padding: 20px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5;">
                                        <h2 style="font-size: 18px; margin: 0 0 10px 0;">Hallo <strong>${paymentEmailInformation.firstName} ${paymentEmailInformation.lastName}</strong>,<br/> danke für deinen Einkauf!</h2>
                                        <p style="margin: 0 0 10px 0;">Du erhältst für jedes deiner Produkte eine E-Mail mit Installationsanweisungen. Überprüfe deinen Spam-Ordner.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 0 20px 20px;">
                                        <img src="cid:mujer-con-tarjeta-credito.png" alt="Frau mit Kreditkarte" width="250" style="max-width: 100%; height: auto;" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 20px 0;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #c7c7c7; border-radius: 8px;">
                                <tr>
                                    <td style="padding: 20px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5;">
                                        <h2 style="font-size: 18px; margin: 0 0 10px 0;">ViajareSIM Quittung</h2>
                                        ...
                                        <p style="margin: 0 0 10px 0;">Bezahlt am ${paymentEmailInformation.datePaid}</p>
                                        <hr style="border: 1px solid #C7C7C7; border-bottom: 0; margin: 10px 0;" />
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Bestellnummer</td>
                                                <td align="right" style="font-family: Arial, sans-serif; font-size: 14px;">#${paymentEmailInformation.orderNumber}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Zahlungsmethode</td>
                    ...
                    <tr>
                        <td style="padding: 20px 0;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #c7c7c7; border-radius: 8px;">
                                <tr>
                                    <td style="padding: 20px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5;">
                                        <h2 style="font-size: 18px; margin: 0 0 10px 0;">Bestellübersicht</h2>
                                        <hr style="border: 1px solid #C7C7C7; border-bottom: 0; margin: 10px 0;" />
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            ${paymentEmailInformation.purchasedPlans.map(plan => generateLineItem(plan)).join('')}
                                            <tr>
                                                <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Rabatt</td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" style="background-color: #f8f8fb;">
                                            <tr>
                                                <td style="font-family: Arial, sans-serif; font-size: 14px;"><strong>Gesamt</strong></td>
...
function generateLineItem(plan: PlanPricingInfo) {
    return `
        ...
        <tr>
            <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Daten</td>
            <td align="right" style="font-family: Arial, sans-serif; font-size: 14px;">${plan.data}</td>
        </tr>
        <tr>
            <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Dauer</td>
            <td align="right" style="font-family: Arial, sans-serif; font-size: 14px;">${plan.duration} Tage</td>
        </tr>
        <tr>
            <td style="font-family: Arial, sans-serif; font-size: 14px; color: #898989;">Preis</td>
