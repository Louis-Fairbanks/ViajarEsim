...
const Header = () => {
  return (
    <div className='flex flex-row-reverse lg:flex-row px-32 lg:px-16 xl:px-32 py-16 justify-between items-center flex-shrink-0 border-b-custom border-accent'>
      <CartOpener/>
      <Link href='/'>
