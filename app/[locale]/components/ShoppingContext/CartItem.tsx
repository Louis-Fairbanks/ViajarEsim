            ...
            <div className='flex justify-between items-center'>
                ...
                <div className="relative w-65 h-65 overflow-hidden rounded-full border-custom pb-8">
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className='text-small text-text-faded'>{plan.duracion === '1' ? `1 ${translations('dia')} ` : `${plan.duracion} ${translations('dias')} `}
                        {plan.data === 'unlimited' ? translations('datosIlimitados') : dataNoGB + ' GB'}</p>
