...
const PlanReadyToInstall = () => {
    return (
        <div className='bg-green-gradient rounded-2xl mx-24 sm:mx-64 flex justify-between p-24 sm:p-64 relative -z-[1]'>
            ...
            <ButtonDark extraClasses='px-32 py-8 w-full sm:w-3/4 lg:w-1/2'>Ver proceso de activación</ButtonDark>
            </div>
