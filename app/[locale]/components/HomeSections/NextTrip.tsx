...
const NextTrip = () => {
  ...
  return (
    <div className="p-24 sm:p-64 flex flex-col items-center space-y-48 relative">
      <Image className='hidden sm:absolute left-64 top-256 sm:top-128 mt-32 scale-200 -z-10'
      ...
      />
      <div className='w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-24'>
