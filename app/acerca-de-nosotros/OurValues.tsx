...
import { OurValuesItems } from '../components/Beneficios'
...
const OurValues = () => {
    ...
    return (
        <div className='flex flex-col px-24 sm:px-0 space-y-12 overflow-hidden mt-48'>
    ...
    `} style={{ transform: `translateX(-${translateXPercentage}px)` }}>
              {
                OurValuesItems.map((benefit, index) => (
                    <AdvantageBlurb
                        key={index}
